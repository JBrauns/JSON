...
(setq casey-todo-file "c:/Users/Joshi/Documents/GitHub/JSON/misc/src/todo.txt")
(setq casey-log-file "c:/Users/Joshi/Documents/GitHub/JSON/misc/src/log.txt")
...
(make-face 'font-lock-own-types-face)
(mapc (lambda (mode)
	(font-lock-add-keywords
	 ...
	 '(("\\<\\(TODO\\)" 1 'font-lock-fixme-face t)
	   ...
	   ("\\<\\(void \\|u8 \\|u16 \\|u32 \\|u64 \\|s8 \\|s16 \\|s32 \\|s64 \\)" 1 'font-lock-own-types-face nil)
	   )
	 )
	)
      fixme-modes)
...
(modify-face 'font-lock-own-types-face "#5AA8E9" nil nil t nil nil nil nil)
...
(defun insert-new-line-below ()
  ...
  (end-of-line)
  (newline-and-indent))
(global-set-key [(control return)] 'insert-new-line-below)
...
(global-set-key [(control shift return)] 'insert-new-line-above)
...
(add-to-list 'default-frame-alist '(font . "Consolas-8.5"))
(set-face-attribute 'default t :font "Consolas-8.5")

(set-face-attribute 'font-lock-builtin-face nil :foreground "#3578C8")
(set-face-attribute 'font-lock-comment-face nil :foreground "#67706F")
(set-face-attribute 'font-lock-constant-face nil :foreground "#e9838a")
(set-face-attribute 'font-lock-doc-face nil :foreground "gray50")
(set-face-attribute 'font-lock-function-name-face nil :foreground "#cbb741")
(set-face-attribute 'font-lock-keyword-face nil :foreground "#7FB9D8")
(set-face-attribute 'font-lock-function-name-face nil :foreground "#db9e64")
(set-face-attribute 'font-lock-type-face nil :foreground "#5AA8E9")
(set-face-attribute 'font-lock-variable-name-face nil :foreground "#969e9d")

; font-lock-number
(make-face 'font-lock-number-face)
(set-face-foreground 'font-lock-number-face "#BEDAB1")
...
(defun post-load-stuff ()
  ...
  (menu-bar-mode -1)
  (maximize-frame)
  (set-foreground-color "#cbd3d2")
  (set-background-color "#1E1E1E")
  (set-cursor-color "#D3DAD9")
)
